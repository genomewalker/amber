...
struct Bin2Config {
    ...
    float consensus_threshold = 0.5f;  // min fraction of encoder runs co-binning a pair

    // Number of augmented views per contig (default: 6)
    int n_views = 6;
    ...
    bool use_scg_supcon = false;   // SupCon: move co-genomic pairs to positive set
